...
export default function Rating(props) {
    ...
    return (
        <div className="rating">
                ...
                <span>
                    <i className={rating >=4?"fa fa-star": rating<=4.5?"fa fa-star-half-o":"fa fa-star-o"}></i>
                </span>
                <span>
                    <i className={rating >=5?"fa fa-star": rating<=5?"fa fa-star-half-o":"fa fa-star-o"}></i>
                </span>
                <span>{numReviews} <strong>Reviews</strong></span>
            </div>
